...
public class OI {
    ...
    public JoystickButton bringArmBackButton;
    ...
    public OI() {
        ...
        fireButton = new JoystickButton(gamepad, 4);
        fireButton.whenPressed(new FireBall());
        grabBallButton = new JoystickButton(gamepad, 3);
        grabBallButton.whenPressed(new GrabBall());
        bringArmBackButton = new JoystickButton(gamepad, 2);
        bringArmBackButton.whenPressed(new BringArmBack());
        slowDown = new JoystickButton(gamepad, 5);
        slowDown.whileHeld(new TankDrive(.7));
        ...
        SmartDashboard.putData("HoldArm", new HoldArm());
        SmartDashboard.putData("ReleaseArm", new ReleaseArm());
        SmartDashboard.putData("WindUp: pullBack", new WindUp(3));
        SmartDashboard.putData("ReleaseWinch: release", new ReleaseWinch(3));
        SmartDashboard.putData("GrabBall", new GrabBall());
        SmartDashboard.putData("BringArmBack", new BringArmBack());
